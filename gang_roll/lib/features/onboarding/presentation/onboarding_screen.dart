...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const _slides = <_Slide>[
    _Slide(
      before: 'Snap with ',
      emphasis: 'your gang',
      body: 'Create a roll. Invite your friends. Every photo from your '
    ...
    _Slide(
      before: 'Develop ',
      emphasis: 'together',
      body: "Photos stay locked while the roll is live. When time's up — the "
